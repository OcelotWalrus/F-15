...
#print("awg_9: update tgt_list+");
            ...
            foreach( var c; raw_list )
            {
                ...
                if (type == "multiplayer" or type == "tanker" or type == "aircraft"
                    or type == "ship" or type == "groundvehicle" or type == "aim-120c" or type == "aim-7" or type == "aim-9" or type == "aim-9x" or type == "aim-120d" or type == "mk-83" or type == "mk-84" or type == "lau-68" or type == "cbu-105" or type == "cbu-87" or type == "b61-12") 
                {
